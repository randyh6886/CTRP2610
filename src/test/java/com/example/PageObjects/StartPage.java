...
public class StartPage extends BaseClass {
    ...
    public void clickTrialsMenuOption() throws Throwable{
        getDriver().findElement(By.id("trialSearchMenuOption"));
        //By.id("trialSearchMenuOption").findElement(getDriverriver).click();
    }
